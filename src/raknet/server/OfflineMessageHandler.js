...
const UnconnectedPing = raknet("protocol/UnconnectedPing");
const UnconnectedPong = raknet("protocol/UnconnectedPong");
const OpenConnectionRequest1 = raknet("protocol/OpenConnectionRequest1");
const OpenConnectionRequest2 = raknet("protocol/OpenConnectionRequest2");
const OpenConnectionReply1 = raknet("protocol/OpenConnectionReply1");
const OpenConnectionReply2 = raknet("protocol/OpenConnectionReply2");
const IncompatibleProtocolVersion = raknet("protocol/IncompatibleProtocolVersion");
